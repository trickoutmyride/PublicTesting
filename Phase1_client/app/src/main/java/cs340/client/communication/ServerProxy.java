...
public class ServerProxy implements IServer{
	...
	public void createGame(Object request) {
		...
		ICommand command = CommandManager.getInstance().makeCommand("createGame", request);
	...
	public void joinGame(Object request) {
		...
		ICommand command = CommandManager.getInstance().makeCommand("joinGame", request);
	...
	public void login(Object request) {
		...
		ICommand command = CommandManager.getInstance().makeCommand("login", request);
	...
	public void register(Object request) {
		...
		ICommand command = CommandManager.getInstance().makeCommand("register", request);
