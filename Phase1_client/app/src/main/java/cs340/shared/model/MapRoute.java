...
public class MapRoute {
    ...
    static {
        ...
        routes.add(new MapRoute(City.ATLANTA, City.CHARLESTON, 2, R.color.train_gray));
        routes.add(new MapRoute(City.ATLANTA, City.MIAMI, 5, R.color.train_blue));
        routes.add(new MapRoute(City.ATLANTA, City.NASHVILLE, 1, R.color.train_gray));
        ...
        routes.add(new MapRoute(City.ATLANTA, City.RALEIGH, 2, R.color.train_gray));
        routes.add(new MapRoute(City.ATLANTA, City.RALEIGH, 2, R.color.train_gray));
        routes.add(new MapRoute(City.BOSTON, City.MONTREAL, 2, R.color.train_gray));
        routes.add(new MapRoute(City.BOSTON, City.MONTREAL, 2, R.color.train_gray));
        ...
        routes.add(new MapRoute(City.CALGARY, City.HELENA, 4, R.color.train_gray));
        routes.add(new MapRoute(City.CALGARY, City.SEATTLE, 4, R.color.train_gray));
        routes.add(new MapRoute(City.CALGARY, City.VANCOUVER, 3, R.color.train_gray));
        ...
        routes.add(new MapRoute(City.CHARLESTON, City.RALEIGH, 2, R.color.train_gray));
        ...
        routes.add(new MapRoute(City.DALLAS, City.HOUSTON, 1, R.color.train_gray));
        routes.add(new MapRoute(City.DALLAS, City.HOUSTON, 1, R.color.train_gray));
        routes.add(new MapRoute(City.DALLAS, City.LITTLE_ROCK, 2, R.color.train_gray));
        routes.add(new MapRoute(City.DALLAS, City.OKLAHOMA_CITY, 2, R.color.train_gray));
        routes.add(new MapRoute(City.DALLAS, City.OKLAHOMA_CITY, 2, R.color.train_gray));
        ...
        routes.add(new MapRoute(City.DENVER, City.SANTA_FE, 2, R.color.train_gray));
        routes.add(new MapRoute(City.DULUTH, City.HELENA, 6, R.color.train_orange)); // orange
        routes.add(new MapRoute(City.DULUTH, City.OMAHA, 2, R.color.train_gray));
        routes.add(new MapRoute(City.DULUTH, City.OMAHA, 2, R.color.train_gray));
        routes.add(new MapRoute(City.DULUTH, City.SAULT_ST_MARIE, 3, R.color.train_gray));
        ...
        routes.add(new MapRoute(City.EL_PASO, City.PHOENIX, 3, R.color.train_gray));
        routes.add(new MapRoute(City.EL_PASO, City.SANTA_FE, 2, R.color.train_gray));
        ...
        routes.add(new MapRoute(City.HOUSTON, City.NEW_ORLEANS, 2, R.color.train_gray));
        routes.add(new MapRoute(City.KANSAS_CITY, City.OKLAHOMA_CITY, 2, R.color.train_gray));
        routes.add(new MapRoute(City.KANSAS_CITY, City.OKLAHOMA_CITY, 2, R.color.train_gray)); // pink
        routes.add(new MapRoute(City.KANSAS_CITY, City.OMAHA, 1, R.color.train_gray));
        routes.add(new MapRoute(City.KANSAS_CITY, City.OMAHA, 1, R.color.train_gray));
        ...
        routes.add(new MapRoute(City.LAS_VEGAS, City.LOS_ANGELES, 2, R.color.train_gray));
        ...
        routes.add(new MapRoute(City.LITTLE_ROCK, City.OKLAHOMA_CITY, 2, R.color.train_gray));
        routes.add(new MapRoute(City.LITTLE_ROCK, City.ST_LOUIS, 2, R.color.train_gray));
        routes.add(new MapRoute(City.LOS_ANGELES, City.PHOENIX, 3, R.color.train_gray));
        ...
        routes.add(new MapRoute(City.MONTREAL, City.TORONTO, 3, R.color.train_gray));
        ...
        routes.add(new MapRoute(City.NASHVILLE, City.ST_LOUIS, 2, R.color.train_gray));
        ...
        routes.add(new MapRoute(City.PHOENIX, City.SANTA_FE, 3, R.color.train_gray));
        routes.add(new MapRoute(City.PITTSBURGH, City.RALEIGH, 2, R.color.train_gray));
        routes.add(new MapRoute(City.PITTSBURGH, City.ST_LOUIS, 5, R.color.train_green));
        routes.add(new MapRoute(City.PITTSBURGH, City.TORONTO, 2, R.color.train_gray));
        routes.add(new MapRoute(City.PITTSBURGH, City.WASHINGTON, 2, R.color.train_gray));
        ...
        routes.add(new MapRoute(City.PORTLAND, City.SEATTLE, 1, R.color.train_gray));
        routes.add(new MapRoute(City.PORTLAND, City.SEATTLE, 1, R.color.train_gray));
        routes.add(new MapRoute(City.RALEIGH, City.WASHINGTON, 2, R.color.train_gray));
        routes.add(new MapRoute(City.RALEIGH, City.WASHINGTON, 2, R.color.train_gray));
        ...
        routes.add(new MapRoute(City.SAULT_ST_MARIE, City.TORONTO, 2, R.color.train_gray));
        routes.add(new MapRoute(City.SAULT_ST_MARIE, City.WINNIPEG, 6, R.color.train_gray));
        routes.add(new MapRoute(City.SEATTLE, City.VANCOUVER, 1, R.color.train_gray));
        routes.add(new MapRoute(City.SEATTLE, City.VANCOUVER, 1, R.color.train_gray));
